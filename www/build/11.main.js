...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__buyer__ = __webpack_require__(405);
...
BuyerPage = __decorate([
    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Component */])({
        selector: 'page-buyer',template:/*ion-inline-start:"H:\ionic\mall\src\pages\buyer\buyer.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>买家</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n\n  <ion-list>\n    <ion-item *ngFor=\'let item of accounts;let i = index\' (click)=\'push(item)\'>\n      <ion-avatar item-left>\n        <img [src]=\'item.userImgUrl\'>\n      </ion-avatar>\n      <h2>{{item.userName}}</h2>\n      <p>{{item._id}}购买列表</p>\n    </ion-item>\n  </ion-list>\n\n</ion-content>'/*ion-inline-end:"H:\ionic\mall\src\pages\buyer\buyer.html"*/,
    }),
